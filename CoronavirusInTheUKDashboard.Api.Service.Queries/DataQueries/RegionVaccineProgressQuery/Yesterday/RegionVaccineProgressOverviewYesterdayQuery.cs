...
{
    public class RegionVaccineProgressOverviewYesterdayQuery : QueryBase, IRegionVaccineProgressOverviewYesterdayQuery
    {
        public IQueryEngine<RegionVaccineProgressQueryModel> Query { get; set; }
        public RegionVaccineProgressOverviewYesterdayQuery(IQueryEngine<RegionVaccineProgressQueryModel> query)
        {
            Query = query;
        }
